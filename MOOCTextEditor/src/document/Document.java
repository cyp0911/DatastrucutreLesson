...
//		int numOfGetNumWords = getNumWords();
		double scores = 206.835 - (1.015 * (double)getNumWords()/getNumSentences()) 
				- (84.6 * ((double)getNumSyllables())/getNumWords());
		System.out.println("\nnumOfGetNumWords: " + scores);

//		System.out.println("passed.\n");
		System.out.println("\nnumOfGetNumWords: " + wordsNum);
		return 5;
	}
